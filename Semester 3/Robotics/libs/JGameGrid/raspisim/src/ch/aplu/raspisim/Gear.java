...
public class Gear extends Part
{
   ...
   */
  synchronized public void forward(int duration)
  {
    RobotInstance.checkRobot();
    state = GearState.FORWARD;
    if (speed != 0)
   ...
   * Method returns immediately, while the movement continues.
   */
  synchronized public void backward()
  {
    RobotInstance.checkRobot();
   ...
   * @param duration the duration (in ms)
   */
  synchronized public void backward(int duration)
  {
    RobotInstance.checkRobot();
    state = GearState.BACKWARD;
    if (speed != 0)
   ...
   * @param duration the duration (in ms)
   */
  synchronized public void left(int duration)
  {
    RobotInstance.checkRobot();
    left();
    Tools.delay(duration);
   ...
   * @param duration the duration (in ms)
   */
  synchronized public void right(int duration)
  {
    RobotInstance.checkRobot();
    right();
    Tools.delay(duration);
   ...
   */
  synchronized public void leftArc(double radius)
  {
    RobotInstance.checkRobot();
    state = GearState.LEFT;
   ...
   * @param duration the duration (in ms)
   */
  synchronized public void leftArc(double radius, int duration)
  {
    RobotInstance.checkRobot();
    leftArc(radius);
    Tools.delay(duration);
   ...
   * @param radius the radius of the arc; if negative, moves backward
   */
  synchronized public void rightArc(double radius)
  {
    RobotInstance.checkRobot();
    state = GearState.RIGHT;
    this.radius = SharedConstants.pixelPerMeter * radius;
   ...
   * @param duration the duration (in ms)
   */
  synchronized public void rightArc(double radius, int duration)
  {
    RobotInstance.checkRobot();
    rightArc(radius);
    Tools.delay(duration);
