...
public class UltrasonicSensor extends Part
{
   ...
   */
  synchronized public int setTriggerLevel(int triggerLevel)
  {
   ...
   */
  synchronized public void setMeshTriangleColor(Color color)
  {
   ...
   */
  synchronized public void setBeamAreaColor(Color color)
  {
    sectorColor = color;
  }
   ...
   */
  synchronized public void eraseBeamArea()
  {
   ...
   */
  synchronized public void setProximityCircleColor(Color color)
  {
