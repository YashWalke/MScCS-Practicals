...
public class TurtleRobot extends Robot
{
   ...
   * @param speed 0..100
   */
  synchronized public void setTurtleSpeed(int speed)
  {
    gear.setSpeed(speed);
  }
   ...
   * @return speed 0..100
   */
  synchronized public int getTurtleSpeed()
  {
   ...
   */
  synchronized public void forward(int steps)
  {
   ...
   * @param steps the number of steps to go.
   */
  synchronized public void backward(int steps)
  {
    Location loc = getRobot().getLocation();
    gear.backward();
    double d = 0;
   ...
   */
  synchronized public void right(double angle)
  {
    if (angle == 0)
      return;
    if (angle < 0)
   ...
   * @param angle the angle in degree to rotate.
   */
  synchronized public void left(double angle)
  {
    if (angle == 0)
      return;
    if (angle < 0)
