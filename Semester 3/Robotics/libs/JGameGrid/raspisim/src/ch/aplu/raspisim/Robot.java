...
//        System.out.println("method not accessible");
   ...
   * For the Raspi brick, there is only one button that can be
   * used in autonomous mode as ENTER or ESCAPE button.
   ...
   */
  synchronized public void playTone(double frequency, double duration)
  {
   ...
   */
  synchronized public void playTone(double volume, double frequency, double duration, boolean blocking)
  {
